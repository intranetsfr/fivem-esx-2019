...
--------------------------------------------------------------------------------------------
-- Menu Transporteur -> esx_transporteurjob
--------------------------------------------------------------------------------------------

		if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'transporteur' and not ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'TransporteurActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuTransporteur')
			GUI.Time = GetGameTimer()
		end

  	if (IsControlPressed(1, Config.menujob.clavier) and PlayerData.job ~= nil and PlayerData.job.name == 'Transporteur' and ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'TransporteurActions') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if Config.general.manettes then
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'transporteur' and not ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'TransporteurActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				TriggerEvent('NB:openMenuTransporteur')
				GUI.Time  = GetGameTimer()
			...
			if (IsControlPressed(2, Config.menujob.manette1) and IsControlPressed(2, Config.menujob.manette2) and PlayerData.job ~= nil and PlayerData.job.name == 'transporteur' and ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'TransporteurActions') and (GetGameTimer() - GUI.Time) > 150) then
				TriggerEvent('NB:closeAllSubMenu')
				TriggerEvent('NB:closeAllMenu')
				GUI.Time  = GetGameTimer()
			end
...
-- IdCard
RegisterNetEvent('NB:closeMenuIdCard')
AddEventHandler('NB:closeMenuIdCard', function()

	if ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'idcard') then
		ESX.UI.Menu.Close('default', GetCurrentResourceName(), 'idcard')
	end
end)

-- Accessoires
RegisterNetEvent('NB:closeMenuAccessoryMenu')
AddEventHandler('NB:closeMenuAccessoryMenu', function()

	if ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'set_unset_accessory') then
...
-- Transporteur
RegisterNetEvent('NB:closeMenuTransporteur')
AddEventHandler('NB:closeMenuTransporteur', function()
	if ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'citizen_interaction') then
		ESX.UI.Menu.Close('default', 'esx_transporteurjob', 'citizen_interaction')
	end
end)
...
Citizen.CreateThread(function()
	while true do
		...
		(ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'menuperso_modo')) or
		(ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'idcard')) or
		...
		-- (ESX.UI.Menu.IsOpen('default', 'idcard', 'idcard')) or
		
		(ESX.UI.Menu.IsOpen('default', 'esx_accessories', 'set_unset_accessory')) or
		...
		(ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'TransporteurActions')) or
		(ESX.UI.Menu.IsOpen('default', 'esx_transporteurjob', 'citizen_interaction')) or
